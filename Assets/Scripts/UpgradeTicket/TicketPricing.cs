...
public class TicketPricing : MonoBehaviour
{
    ...
    void Start()
    {
        ticketInputField.onValueChanged.AddListener(OnTicketCountChanged);
    }

    private void OnTicketCountChanged(string value)
    {
